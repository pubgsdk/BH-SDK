...
#include "TBP_UI_ScoutedPlayerMarker_structs.hpp"
...
class UTBP_UI_ScoutedPlayerMarker_C : public UTBP_UI_MapMarker_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass TBP_UI_ScoutedPlayerMarker.TBP_UI_ScoutedPlayerMarker_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_TBP_UI_ScoutedPlayerMarker(int EntryPoint);
};
