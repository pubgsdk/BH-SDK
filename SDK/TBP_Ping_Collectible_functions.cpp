...
#include "TBP_Ping_Collectible_classes.hpp"
...
// Function TBP_Ping_Collectible.TBP_Ping_Collectible_C.EvaluateWorldActor
...
bool UTBP_Ping_Collectible_C::EvaluateWorldActor(class ATigerPlayerState* InPlayerState, const struct FHitResult& InHitResult, struct FTigerPingWorldNetData* OutPingData, class AActor** OutOverrideActor)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_Ping_Collectible.TBP_Ping_Collectible_C.EvaluateWorldActor"));
