...
#include "TBP_Ping_RespawnStation_classes.hpp"
...
// Function TBP_Ping_RespawnStation.TBP_Ping_RespawnStation_C.EvaluateWorldActor
...
bool UTBP_Ping_RespawnStation_C::EvaluateWorldActor(class ATigerPlayerState* InPlayerState, const struct FHitResult& InHitResult, struct FTigerPingWorldNetData* OutPingData, class AActor** OutOverrideActor)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_Ping_RespawnStation.TBP_Ping_RespawnStation_C.EvaluateWorldActor"));
