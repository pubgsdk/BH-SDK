...
#include "BP_ElectricityBox_04_structs.hpp"
...
// BlueprintGeneratedClass BP_ElectricityBox_04.BP_ElectricityBox_04_C
// 0x0024 (0x0270 - 0x024C)
class ABP_ElectricityBox_04_C : public ABP_GraffitiParent_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ElectricityBox_04.BP_ElectricityBox_04_C"));
		return ptr;
	}


	void SetCustomPrimitiveData(class UPrimitiveComponent* PrimitiveComponent);
	void UserConstructionScript();
	void ReceiveBeginPlay();
	void ExecuteUbergraph_BP_ElectricityBox_04(int EntryPoint);
};
