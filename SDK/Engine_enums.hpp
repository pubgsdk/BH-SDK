...
enum class EQuartzCommandQuantization : uint8_t
{
	...
	EQuartzCommandQuantization__EQuartzCommandQuantization_MAX = 19
};
...
enum class EAudioBusChannels : uint8_t
{
	...
	EAudioBusChannels__EAudioBusChannels_MAX = 2
};
...
{
	ECameraShakeUpdateResultFlags__ApplyAsAbsolute = 0,
	ECameraShakeUpdateResultFlags__SkipAutoScale = 1,
	ECameraShakeUpdateResultFlags__SkipAutoPlaySpace = 2,
	ECameraShakeUpdateResultFlags__Default = 3,
	ECameraShakeUpdateResultFlags__ECameraShakeUpdateResultFlags_MAX = 4
};
...
// Enum Engine.EActorStreamingPriorityTiers
...
// Enum Engine.EShadowDetailMode
enum class EShadowDetailMode : uint8_t
{
	EShadowDetailMode__SDM_Low     = 0,
	EShadowDetailMode__SDM_Medium  = 1,
	EShadowDetailMode__SDM_High    = 2,
	EShadowDetailMode__SDM_MAX     = 3
};
...
// Enum Engine.EConditionalTextureComparisonOperator
enum class EConditionalTextureComparisonOperator : uint8_t
{
	EConditionalTextureComparisonOperator__GreaterThan = 0,
	EConditionalTextureComparisonOperator__GreaterThanOrEqual = 1,
	EConditionalTextureComparisonOperator__LessThan = 2,
	EConditionalTextureComparisonOperator__LessThanOrEqual = 3,
	EConditionalTextureComparisonOperator__Equal = 4,
	EConditionalTextureComparisonOperator__NotEqual = 5,
	EConditionalTextureComparisonOperator__EConditionalTextureComparisonOperator_MAX = 6
};
...
// Enum Engine.EParticleResolutionMode
enum class EParticleResolutionMode : uint8_t
{
	EParticleResolutionMode__Full  = 0,
	EParticleResolutionMode__Quarter = 1,
	EParticleResolutionMode__Sixteenth = 2,
	EParticleResolutionMode__EParticleResolutionMode_MAX = 3
};
...
enum class EMobileReflectionCompression : uint8_t
{
	...
	EMobileReflectionCompression__EMobileReflectionCompression_MAX = 3
};
...
enum class EEarlyZPass : uint8_t
{
	...
	EEarlyZPass__Manual            = 3,
	EEarlyZPass__Auto              = 4,
	EEarlyZPass__EEarlyZPass_MAX   = 5
};
...
enum class EVertexOffsetUsageType : uint8_t
{
	...
	EVertexOffsetUsageType__EVertexOffsetUsageType_MAX = 3
};
...
enum class EModulationRouting : uint8_t
{
	...
	EModulationRouting__EModulationRouting_MAX = 3
};
...
// Enum Engine.EStaticMeshTranslucencyResolutionMode
enum class EStaticMeshTranslucencyResolutionMode : uint8_t
{
	EStaticMeshTranslucencyResolutionMode__Full = 0,
	EStaticMeshTranslucencyResolutionMode__Quarter = 1,
	EStaticMeshTranslucencyResolutionMode__Sixteenth = 2,
	EStaticMeshTranslucencyResolutionMode__EStaticMeshTranslucencyResolutionMode_MAX = 3
};
