...
#include "TBP_WallJumpEffect_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_WallJumpEffect.TBP_WallJumpEffect_C.HandleVFX"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_WallJumpEffect.TBP_WallJumpEffect_C.ApplyWithSocket"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_WallJumpEffect.TBP_WallJumpEffect_C.ExecuteUbergraph_TBP_WallJumpEffect"));
