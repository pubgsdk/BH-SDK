...
#include "ABP_VMP_TOR_F_HAIR_08_structs.hpp"
...
// AnimBlueprintGeneratedClass ABP_VMP_TOR_F_HAIR_08.ABP_VMP_TOR_F_HAIR_08_C
// 0x37C0 (0x3A80 - 0x02C0)
class UABP_VMP_TOR_F_HAIR_08_C : public UAnimInstance
{
public:
	...
	struct FAnimNode_AnimDynamics                      AnimGraphNode_AnimDynamics_10;                            // 0x0FB0(0x0440)
	struct FAnimNode_AnimDynamics                      AnimGraphNode_AnimDynamics_9;                             // 0x13F0(0x0440)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass ABP_VMP_TOR_F_HAIR_08.ABP_VMP_TOR_F_HAIR_08_C"));
		return ptr;
	}


	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_ABP_VMP_TOR_F_HAIR_08(int EntryPoint);
};
