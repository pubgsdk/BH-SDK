...
#include "TBP_Buff_KindredCharm_Player_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass TBP_Buff_KindredCharm_Player.TBP_Buff_KindredCharm_Player_C"));
		return ptr;
	}
