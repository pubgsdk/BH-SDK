...
#include "TBP_MeleeWeapon_Master_classes.hpp"
...
void UTBP_MeleeWeapon_Master_C::GetMeleeWeaponCategory(TEnumAsByte<ENUM_MeleeWeaponCategories>* MeleeWeaponCategory)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_MeleeWeapon_Master.TBP_MeleeWeapon_Master_C.GetMeleeWeaponCategory"));
...
// struct FHitResult              InWorldObjectHitResult         (CPF_ConstParm, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_OutParm, CPF_ReferenceParm, CPF_IsPlainOldData, CPF_NoDestructor, CPF_ContainsInstancedReference)
// struct FVector                 InSwingDirection               (CPF_ConstParm, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReferenceParm, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_MeleeWeapon_Master.TBP_MeleeWeapon_Master_C.OnWorldObjectHit"));

	struct
	{
		class ATigerCharacter*         InInstigator;
		struct FHitResult              InWorldObjectHitResult;
		struct FVector                 InSwingDirection;
	} params = {};
...
// ETigerWeaponMeleeAttackType    AttackType                     (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
...
void UTBP_MeleeWeapon_Master_C::OnHit(class ATigerCharacter* Instigator, class ATigerCharacter* Target, ETigerWeaponMeleeAttackType AttackType, float Damage)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_MeleeWeapon_Master.TBP_MeleeWeapon_Master_C.OnHit"));

	struct
	{
		class ATigerCharacter*         Instigator;
		class ATigerCharacter*         Target;
		ETigerWeaponMeleeAttackType    AttackType;
		float                          Damage;
	} params = {};
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_MeleeWeapon_Master.TBP_MeleeWeapon_Master_C.ExecuteUbergraph_TBP_MeleeWeapon_Master"));
