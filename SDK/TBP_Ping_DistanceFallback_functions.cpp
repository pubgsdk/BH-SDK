...
#include "TBP_Ping_DistanceFallback_classes.hpp"
...
// Function TBP_Ping_DistanceFallback.TBP_Ping_DistanceFallback_C.GetNotificationVoiceAudioEvent
...
void UTBP_Ping_DistanceFallback_C::GetNotificationVoiceAudioEvent(const struct FTigerPingContext& InContext, class UAkAudioEvent** OutAudioEvent)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_Ping_DistanceFallback.TBP_Ping_DistanceFallback_C.GetNotificationVoiceAudioEvent"));
...
// Function TBP_Ping_DistanceFallback.TBP_Ping_DistanceFallback_C.EvaluateWorldActor
...
bool UTBP_Ping_DistanceFallback_C::EvaluateWorldActor(class ATigerPlayerState* InPlayerState, const struct FHitResult& InHitResult, struct FTigerPingWorldNetData* OutPingData, class AActor** OutOverrideActor)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_Ping_DistanceFallback.TBP_Ping_DistanceFallback_C.EvaluateWorldActor"));
