...
#include "TBP_RangedWeapon_DualCrossbows_classes.hpp"
...
// Function TBP_RangedWeapon_DualCrossbows.TBP_RangedWeapon_DualCrossbows_C.OnHitAuthority
...
void UTBP_RangedWeapon_DualCrossbows_C::OnHitAuthority(class ATigerCharacter* Instigator, class ATigerCharacter* Target)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_RangedWeapon_DualCrossbows.TBP_RangedWeapon_DualCrossbows_C.OnHitAuthority"));
