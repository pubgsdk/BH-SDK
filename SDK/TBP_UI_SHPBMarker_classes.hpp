...
#include "TBP_UI_SHPBMarker_structs.hpp"
...
// WidgetBlueprintGeneratedClass TBP_UI_SHPBMarker.TBP_UI_SHPBMarker_C
// 0x0010 (0x02E8 - 0x02D8)
class UTBP_UI_SHPBMarker_C : public UTBP_UI_MapMarker_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass TBP_UI_SHPBMarker.TBP_UI_SHPBMarker_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_TBP_UI_SHPBMarker(int EntryPoint);
};
