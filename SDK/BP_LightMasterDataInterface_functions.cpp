...
#include "BP_LightMasterDataInterface_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LightMasterDataInterface.BP_LightMasterDataInterface_C.GetIESProfile"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LightMasterDataInterface.BP_LightMasterDataInterface_C.GetLightMateriales"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LightMasterDataInterface.BP_LightMasterDataInterface_C.GetLightMeshes"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LightMasterDataInterface.BP_LightMasterDataInterface_C.GetLightFlickerMaterial"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LightMasterDataInterface.BP_LightMasterDataInterface_C.GetLightOffMaterial"));
