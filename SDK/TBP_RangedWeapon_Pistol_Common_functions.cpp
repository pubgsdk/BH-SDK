...
#include "TBP_RangedWeapon_Pistol_Common_classes.hpp"
...
// Function TBP_RangedWeapon_Pistol_Common.TBP_RangedWeapon_Pistol_Common_C.OnHitAuthority
...
void UTBP_RangedWeapon_Pistol_Common_C::OnHitAuthority(class ATigerCharacter* Instigator, class ATigerCharacter* Target)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_RangedWeapon_Pistol_Common.TBP_RangedWeapon_Pistol_Common_C.OnHitAuthority"));
