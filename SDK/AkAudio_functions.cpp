...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AkAudio.AkPortalComponent.PortalPlacementValid"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AkAudio.AkPortalComponent.OpenPortal"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AkAudio.AkPortalComponent.GetPrimitiveParent"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AkAudio.AkPortalComponent.GetCurrentState"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AkAudio.AkPortalComponent.ClosePortal"));
...
// (FUNC_Final, FUNC_BlueprintCosmetic, FUNC_Native, FUNC_Public, FUNC_BlueprintCallable, FUNC_Const)
// Parameters:
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AkAudio.AkGameObject.SetRTPCValue"));
...
// (FUNC_Final, FUNC_BlueprintCosmetic, FUNC_Native, FUNC_Public, FUNC_HasOutParms, FUNC_BlueprintCallable, FUNC_BlueprintPure, FUNC_Const)
// Parameters:
// class UAkRtpc*                 RTPCValue                      (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AkAudio.AkGameObject.GetRTPCValue"));
...
// (FUNC_Final, FUNC_Native, FUNC_Public, FUNC_BlueprintCallable)
// Parameters:
// float                          in_outerRadius                 (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
// float                          in_innerRadius                 (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)

void UAkComponent::SetGameObjectRadius(float in_outerRadius, float in_innerRadius)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AkAudio.AkComponent.SetGameObjectRadius"));
...
// (FUNC_Final, FUNC_Native, FUNC_Static, FUNC_Public, FUNC_HasOutParms, FUNC_BlueprintCallable)
// Parameters:
// struct FAkOutputSettings       MainOutputSettings             (CPF_ConstParm, CPF_Parm, CPF_OutParm, CPF_ReferenceParm, CPF_NativeAccessSpecifierPublic)

void UAkGameplayStatics::ReplaceMainOutput(const struct FAkOutputSettings& MainOutputSettings)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AkAudio.AkGameplayStatics.ReplaceMainOutput"));
...
// Function AkAudio.AkGameplayStatics.GetDeviceList
// (FUNC_Final, FUNC_Native, FUNC_Static, FUNC_Public, FUNC_BlueprintCallable)
// Parameters:
// TArray<struct FAkDeviceInfo>   ReturnValue                    (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReturnParm, CPF_NativeAccessSpecifierPublic)

TArray<struct FAkDeviceInfo> UAkGameplayStatics::GetDeviceList()
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AkAudio.AkGameplayStatics.GetDeviceList"));

	struct
	{
		TArray<struct FAkDeviceInfo>   ReturnValue;
	} params = {};
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AkAudio.AkGeometryComponent.SendGeometry"));
...
// (FUNC_Final, FUNC_Native, FUNC_Public, FUNC_BlueprintCallable)
// Parameters:
// class UAkAcousticTextureSetComponent* textureSetComponent            (CPF_Parm, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)

void UAkLateReverbComponent::AssociateAkTextureSetComponent(class UAkAcousticTextureSetComponent* textureSetComponent)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AkAudio.AkLateReverbComponent.AssociateAkTextureSetComponent"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AkAudio.AkRoomComponent.GetPrimitiveParent"));
