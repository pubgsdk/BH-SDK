...
{
public:
	class UBlueprintGeneratedClass* /*UObject*/        DirectorClass;                                            // 0x0028(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPrivate)
...
{
public:
	struct FSoftObjectPath                             LevelVariantSets;                                         // 0x0228(0x0018) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
public:
	...
	TArray<struct FFieldPath>                          Properties;                                               // 0x0088(0x0010) (CPF_ZeroConstructor, CPF_Deprecated, CPF_Protected, CPF_NativeAccessSpecifierProtected)
	...
	class UClass* /*UObject*/                          LeafPropertyClass;                                        // 0x0128(0x0008) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData, CPF_NoDestructor, CPF_Protected, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierProtected)
	...
	unsigned char                                      UnknownData03[0x6F];                                      // 0x0149(0x006F) MISSED OFFSET
...
public:
	...
	class USceneComponent*                             SceneComponent;                                           // 0x0240(0x0008) (CPF_Edit, CPF_ExportObject, CPF_ZeroConstructor, CPF_EditConst, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPrivate)
	int                                                LastSelectedOption;                                       // 0x0248(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPrivate)
