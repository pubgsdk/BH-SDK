...
public:
	...
	struct FMulticastScriptDelegate                    OnClaimedResourcesChange;                                 // 0x0110(0x0010) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_NativeAccessSpecifierPublic)
