...
struct FMovieSceneTrackInstanceComponent
{
	...
	class UClass* /*UMovieSceneTrackInstance*/         TrackInstanceClass;                                       // 0x0008(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
};
