...
#include "TBP_Ping_EnemyLocation_classes.hpp"
...
// Function TBP_Ping_EnemyLocation.TBP_Ping_EnemyLocation_C.EvaluateWorldActor
...
bool UTBP_Ping_EnemyLocation_C::EvaluateWorldActor(class ATigerPlayerState* InPlayerState, const struct FHitResult& InHitResult, struct FTigerPingWorldNetData* OutPingData, class AActor** OutOverrideActor)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_Ping_EnemyLocation.TBP_Ping_EnemyLocation_C.EvaluateWorldActor"));
...
// Function TBP_Ping_EnemyLocation.TBP_Ping_EnemyLocation_C.GetIconData
// (FUNC_Event, FUNC_Public, FUNC_HasOutParms, FUNC_HasDefaults, FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
...
struct FTigerPingIconData UTBP_Ping_EnemyLocation_C::GetIconData(const struct FTigerPingContext& InContext)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_Ping_EnemyLocation.TBP_Ping_EnemyLocation_C.GetIconData"));
