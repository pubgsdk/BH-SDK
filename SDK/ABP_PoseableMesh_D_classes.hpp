...
#include "ABP_PoseableMesh_D_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass ABP_PoseableMesh_D.ABP_PoseableMesh_D_C"));
		return ptr;
	}
