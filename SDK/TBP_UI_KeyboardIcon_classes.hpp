...
#include "TBP_UI_KeyboardIcon_structs.hpp"
...
public:
	...
	bool                                               MatchSize;                                                // 0x0298(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass TBP_UI_KeyboardIcon.TBP_UI_KeyboardIcon_C"));
		return ptr;
	}
