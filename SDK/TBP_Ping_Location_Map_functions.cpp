...
#include "TBP_Ping_Location_Map_classes.hpp"
...
// Function TBP_Ping_Location_Map.TBP_Ping_Location_Map_C.EvaluateWorldActor
...
bool UTBP_Ping_Location_Map_C::EvaluateWorldActor(class ATigerPlayerState* InPlayerState, const struct FHitResult& InHitResult, struct FTigerPingWorldNetData* OutPingData, class AActor** OutOverrideActor)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_Ping_Location_Map.TBP_Ping_Location_Map_C.EvaluateWorldActor"));
