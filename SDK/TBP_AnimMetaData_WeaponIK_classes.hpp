...
#include "TBP_AnimMetaData_WeaponIK_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass TBP_AnimMetaData_WeaponIK.TBP_AnimMetaData_WeaponIK_C"));
		return ptr;
	}
