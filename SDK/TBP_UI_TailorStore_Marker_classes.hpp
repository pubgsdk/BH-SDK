...
#include "TBP_UI_TailorStore_Marker_structs.hpp"
...
// WidgetBlueprintGeneratedClass TBP_UI_TailorStore_Marker.TBP_UI_TailorStore_Marker_C
// 0x0018 (0x02F0 - 0x02D8)
class UTBP_UI_TailorStore_Marker_C : public UTBP_UI_MapMarker_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass TBP_UI_TailorStore_Marker.TBP_UI_TailorStore_Marker_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_TBP_UI_TailorStore_Marker(int EntryPoint);
};
