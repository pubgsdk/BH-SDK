...
#include "TBP_Perk_Choleric_structs.hpp"
...
// BlueprintGeneratedClass TBP_Perk_Choleric.TBP_Perk_Choleric_C
// 0x000C (0x00CC - 0x00C0)
class UTBP_Perk_Choleric_C : public UTigerPassiveComponent
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass TBP_Perk_Choleric.TBP_Perk_Choleric_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_TBP_Perk_Choleric(int EntryPoint);
};
