...
#include "TBP_RangedWeapon_Crossbow_classes.hpp"
...
// Function TBP_RangedWeapon_Crossbow.TBP_RangedWeapon_Crossbow_C.OnHitAuthority
...
void UTBP_RangedWeapon_Crossbow_C::OnHitAuthority(class ATigerCharacter* Instigator, class ATigerCharacter* Target)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_RangedWeapon_Crossbow.TBP_RangedWeapon_Crossbow_C.OnHitAuthority"));
