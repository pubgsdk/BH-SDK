...
#include "TBP_RangedWeapon_SCAR_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass TBP_RangedWeapon_SCAR.TBP_RangedWeapon_SCAR_C"));
		return ptr;
	}
