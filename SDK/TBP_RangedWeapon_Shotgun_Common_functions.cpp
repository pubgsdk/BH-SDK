...
#include "TBP_RangedWeapon_Shotgun_Common_classes.hpp"
...
// Function TBP_RangedWeapon_Shotgun_Common.TBP_RangedWeapon_Shotgun_Common_C.OnHitAuthority
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_RangedWeapon_Shotgun_Common.TBP_RangedWeapon_Shotgun_Common_C.OnHitAuthority"));
...
// Function TBP_RangedWeapon_Shotgun_Common.TBP_RangedWeapon_Shotgun_Common_C.CalculateBulletDirection
...
struct FVector UTBP_RangedWeapon_Shotgun_Common_C::CalculateBulletDirection(const struct FVector& InAimDirection, int InBulletIndex, class UTigerRangedWeaponComponent* InRangedWeaponComponent, struct FTigerRangedRandomState* InOutRandomState)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_RangedWeapon_Shotgun_Common.TBP_RangedWeapon_Shotgun_Common_C.CalculateBulletDirection"));
