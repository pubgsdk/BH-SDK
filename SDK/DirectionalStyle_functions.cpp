...
#include "DirectionalStyle_classes.hpp"
...
ETigerWeaponSlot UDirectionalStyle_C::DetermineNextWeaponSlot(class ATigerPlayerController* InPlayerController, ETigerWeaponCycleDirection InDirection)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function DirectionalStyle.DirectionalStyle_C.DetermineNextWeaponSlot"));
