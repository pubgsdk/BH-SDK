...
#include "BP_HangingLights_01_structs.hpp"
...
// BlueprintGeneratedClass BP_HangingLights_01.BP_HangingLights_01_C
// 0x0044 (0x026C - 0x0228)
class ABP_HangingLights_01_C : public AActor
{
public:
	...
	class UBP_HangingLights_01_DataInterface_C*        HangingLightsCDO;                                         // 0x0260(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_Transient, CPF_DisableEditOnInstance, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	float                                              IntensityMultiplier;                                      // 0x0268(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_HangingLights_01.BP_HangingLights_01_C"));
		return ptr;
	}
