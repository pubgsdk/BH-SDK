...
#include "TBP_RangedWeapon_Sniper_classes.hpp"
...
// Function TBP_RangedWeapon_Sniper.TBP_RangedWeapon_Sniper_C.OnHitAuthority
...
void UTBP_RangedWeapon_Sniper_C::OnHitAuthority(class ATigerCharacter* Instigator, class ATigerCharacter* Target)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_RangedWeapon_Sniper.TBP_RangedWeapon_Sniper_C.OnHitAuthority"));
