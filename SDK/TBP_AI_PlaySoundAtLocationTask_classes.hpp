...
#include "TBP_AI_PlaySoundAtLocationTask_structs.hpp"
...
public:
	...
	class USoundCue*                                   SoundCue;                                                 // 0x00B0(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass TBP_AI_PlaySoundAtLocationTask.TBP_AI_PlaySoundAtLocationTask_C"));
		return ptr;
	}
