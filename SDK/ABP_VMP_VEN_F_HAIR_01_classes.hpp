...
#include "ABP_VMP_VEN_F_HAIR_01_structs.hpp"
...
class UABP_VMP_VEN_F_HAIR_01_C : public UAnimInstance
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass ABP_VMP_VEN_F_HAIR_01.ABP_VMP_VEN_F_HAIR_01_C"));
		return ptr;
	}


	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_ABP_VMP_VEN_F_HAIR_01(int EntryPoint);
};
