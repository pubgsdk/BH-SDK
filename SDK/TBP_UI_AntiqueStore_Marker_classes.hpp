...
#include "TBP_UI_AntiqueStore_Marker_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass TBP_UI_AntiqueStore_Marker.TBP_UI_AntiqueStore_Marker_C"));
		return ptr;
	}
