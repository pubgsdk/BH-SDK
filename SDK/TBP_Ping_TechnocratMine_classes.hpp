...
#include "TBP_Ping_TechnocratMine_structs.hpp"
...
// BlueprintGeneratedClass TBP_Ping_TechnocratMine.TBP_Ping_TechnocratMine_C
// 0x0000 (0x0121 - 0x0121)
class UTBP_Ping_TechnocratMine_C : public UTBP_PingBase_C
{
public:

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass TBP_Ping_TechnocratMine.TBP_Ping_TechnocratMine_C"));
		return ptr;
	}
