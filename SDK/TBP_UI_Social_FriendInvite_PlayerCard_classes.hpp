...
#include "TBP_UI_Social_FriendInvite_PlayerCard_structs.hpp"
...
public:
	...
	class UTigerFriendInvite*                          Invite;                                                   // 0x0370(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass TBP_UI_Social_FriendInvite_PlayerCard.TBP_UI_Social_FriendInvite_PlayerCard_C"));
		return ptr;
	}
