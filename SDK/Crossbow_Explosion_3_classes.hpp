...
#include "Crossbow_Explosion_3_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass Crossbow_Explosion_3.Crossbow_Explosion_2_C"));
		return ptr;
	}
