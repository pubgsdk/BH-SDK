...
#include "TBP_RangedWeapon_DualPistols_classes.hpp"
...
// Function TBP_RangedWeapon_DualPistols.TBP_RangedWeapon_DualPistols_C.OnHitAuthority
...
void UTBP_RangedWeapon_DualPistols_C::OnHitAuthority(class ATigerCharacter* Instigator, class ATigerCharacter* Target)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_RangedWeapon_DualPistols.TBP_RangedWeapon_DualPistols_C.OnHitAuthority"));
