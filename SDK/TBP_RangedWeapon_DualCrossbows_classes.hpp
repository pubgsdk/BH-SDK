...
#include "TBP_RangedWeapon_DualCrossbows_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass TBP_RangedWeapon_DualCrossbows.TBP_RangedWeapon_DualCrossbows_C"));
		return ptr;
	}
