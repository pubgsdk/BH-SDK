...
#include "TBP_StakeProjectile_classes.hpp"
...
// Function TBP_StakeProjectile.TBP_StakeProjectile_C.SpawnVFX
...
void ATBP_StakeProjectile_C::SpawnVFX(const struct FVector& Location, const struct FRotator& Rotation)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_StakeProjectile.TBP_StakeProjectile_C.SpawnVFX"));
...
// Function TBP_StakeProjectile.TBP_StakeProjectile_C.InstantaneousSpawnParticles
// (FUNC_Public, FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
...
void ATBP_StakeProjectile_C::InstantaneousSpawnParticles(TEnumAsByte<EPhysicalSurface> Surface_Type, const struct FVector& Impact_Point, const struct FRotator& Rotation, class UPrimitiveComponent* Potential_Scene_Component, bool BlockingHit)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_StakeProjectile.TBP_StakeProjectile_C.InstantaneousSpawnParticles"));
...
// Function TBP_StakeProjectile.TBP_StakeProjectile_C.ReceiveBeginPlay
// (FUNC_Event, FUNC_Protected, FUNC_BlueprintEvent)

void ATBP_StakeProjectile_C::ReceiveBeginPlay()
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_StakeProjectile.TBP_StakeProjectile_C.ReceiveBeginPlay"));
...
// Function TBP_StakeProjectile.TBP_StakeProjectile_C.ExecuteUbergraph_TBP_StakeProjectile
// (FUNC_Final)
// Parameters:
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_StakeProjectile.TBP_StakeProjectile_C.ExecuteUbergraph_TBP_StakeProjectile"));
