...
#include "TBP_RangedWeapon_Shotgun_Common_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass TBP_RangedWeapon_Shotgun_Common.TBP_RangedWeapon_Shotgun_Common_C"));
		return ptr;
	}
