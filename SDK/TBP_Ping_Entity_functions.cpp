...
#include "TBP_Ping_Entity_classes.hpp"
...
// Function TBP_Ping_Entity.TBP_Ping_Entity_C.ShouldRemovePing
...
bool UTBP_Ping_Entity_C::ShouldRemovePing(class AActor* InContextActor)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_Ping_Entity.TBP_Ping_Entity_C.ShouldRemovePing"));
...
// Function TBP_Ping_Entity.TBP_Ping_Entity_C.GetIconData
...
struct FTigerPingIconData UTBP_Ping_Entity_C::GetIconData(const struct FTigerPingContext& InContext)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_Ping_Entity.TBP_Ping_Entity_C.GetIconData"));
...
// Function TBP_Ping_Entity.TBP_Ping_Entity_C.EvaluateWorldActor
// (FUNC_Event, FUNC_Public, FUNC_HasOutParms, FUNC_HasDefaults, FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
...
bool UTBP_Ping_Entity_C::EvaluateWorldActor(class ATigerPlayerState* InPlayerState, const struct FHitResult& InHitResult, struct FTigerPingWorldNetData* OutPingData, class AActor** OutOverrideActor)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_Ping_Entity.TBP_Ping_Entity_C.EvaluateWorldActor"));
