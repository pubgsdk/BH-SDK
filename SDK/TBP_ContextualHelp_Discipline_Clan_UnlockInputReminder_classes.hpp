...
#include "TBP_ContextualHelp_Discipline_Clan_UnlockInputReminder_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass TBP_ContextualHelp_Discipline_Clan_UnlockInputReminder.TBP_ContextualHelp_Discipline_Clan_UnlockInputReminder_C"));
		return ptr;
	}
