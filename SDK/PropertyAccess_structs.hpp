...
struct FPropertyAccessSegment
{
	...
	struct FFieldPath                                  Property;                                                 // 0x0010(0x0020) (CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPrivate)
...
{
	struct FFieldPath                                  Property;                                                 // 0x0000(0x0020) (CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPrivate)
...
{
	struct FFieldPath                                  ArrayProperty;                                            // 0x0000(0x0020) (CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPrivate)
