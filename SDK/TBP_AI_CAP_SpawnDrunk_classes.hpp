...
#include "TBP_AI_CAP_SpawnDrunk_structs.hpp"
...
// BlueprintGeneratedClass TBP_AI_CAP_SpawnDrunk.TBP_AI_CAP_SpawnDrunk_C
// 0x0010 (0x02B0 - 0x02A0)
class ATBP_AI_CAP_SpawnDrunk_C : public ATigerAIGroupCAP
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass TBP_AI_CAP_SpawnDrunk.TBP_AI_CAP_SpawnDrunk_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_TBP_AI_CAP_SpawnDrunk(int EntryPoint);
};
