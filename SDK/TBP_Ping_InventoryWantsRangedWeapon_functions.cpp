...
#include "TBP_Ping_InventoryWantsRangedWeapon_classes.hpp"
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_Ping_InventoryWantsRangedWeapon.TBP_Ping_InventoryWantsRangedWeapon_C.GetNotificationUIData"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_Ping_InventoryWantsRangedWeapon.TBP_Ping_InventoryWantsRangedWeapon_C.GetIconData"));
