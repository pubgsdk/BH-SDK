...
#include "MobilePatchingUtils_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("Class MobilePatchingUtils.MobileInstalledContent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("Class MobilePatchingUtils.MobilePendingContent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("Class MobilePatchingUtils.MobilePatchingLibrary"));
		return ptr;
	}
