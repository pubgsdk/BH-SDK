...
#include "BP_ElectricityBox_05_structs.hpp"
...
// BlueprintGeneratedClass BP_ElectricityBox_05.BP_ElectricityBox_05_C
// 0x0034 (0x0280 - 0x024C)
class ABP_ElectricityBox_05_C : public ABP_GraffitiParent_C
{
public:
	...
	class UStaticMeshComponent*                        CreatedStaticMesh3;                                       // 0x0278(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ElectricityBox_05.BP_ElectricityBox_05_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_ElectricityBox_05(int EntryPoint);
};
