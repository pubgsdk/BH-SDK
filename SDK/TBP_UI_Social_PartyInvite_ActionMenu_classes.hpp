...
#include "TBP_UI_Social_PartyInvite_ActionMenu_structs.hpp"
...
class UTBP_UI_Social_PartyInvite_ActionMenu_C : public UTBP_UI_Social_ActionMenuBase_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass TBP_UI_Social_PartyInvite_ActionMenu.TBP_UI_Social_PartyInvite_ActionMenu_C"));
		return ptr;
	}


	void GetPartyInviteCard(class UTBP_UI_Social_PartyInvite_PlayerCard_C** OutPlayerCard);
	...
	void Construct();
	void ExecuteUbergraph_TBP_UI_Social_PartyInvite_ActionMenu(int EntryPoint);
};
