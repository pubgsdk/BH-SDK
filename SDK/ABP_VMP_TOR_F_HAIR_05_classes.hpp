...
#include "ABP_VMP_TOR_F_HAIR_05_structs.hpp"
...
class UABP_VMP_TOR_F_HAIR_05_C : public UAnimInstance
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass ABP_VMP_TOR_F_HAIR_05.ABP_VMP_TOR_F_HAIR_05_C"));
		return ptr;
	}


	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_ABP_VMP_TOR_F_HAIR_05(int EntryPoint);
};
