...
public:
	...
	TSet<class USoundConcurrency*>                     ConcurrencySet;                                           // 0x05B0(0x0050) (CPF_Edit, CPF_BlueprintVisible, CPF_NativeAccessSpecifierPublic)
	...
	struct FMulticastScriptDelegate                    OnAudioEnvelopeValue;                                     // 0x0658(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable, CPF_NativeAccessSpecifierPublic)
