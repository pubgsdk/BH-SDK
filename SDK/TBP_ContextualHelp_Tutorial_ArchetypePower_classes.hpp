...
#include "TBP_ContextualHelp_Tutorial_ArchetypePower_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass TBP_ContextualHelp_Tutorial_ArchetypePower.TBP_ContextualHelp_Tutorial_ArchetypePower_C"));
		return ptr;
	}
