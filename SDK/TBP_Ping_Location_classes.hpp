...
#include "TBP_Ping_Location_structs.hpp"
...
// BlueprintGeneratedClass TBP_Ping_Location.TBP_Ping_Location_C
// 0x0000 (0x0121 - 0x0121)
class UTBP_Ping_Location_C : public UTBP_PingBase_C
{
public:

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass TBP_Ping_Location.TBP_Ping_Location_C"));
		return ptr;
	}
