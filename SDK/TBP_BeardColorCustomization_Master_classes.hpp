...
#include "TBP_BeardColorCustomization_Master_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass TBP_BeardColorCustomization_Master.TBP_BeardColorCustomization_Master_C"));
		return ptr;
	}
