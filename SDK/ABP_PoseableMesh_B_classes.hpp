...
#include "ABP_PoseableMesh_B_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass ABP_PoseableMesh_B.ABP_PoseableMesh_B_C"));
		return ptr;
	}
