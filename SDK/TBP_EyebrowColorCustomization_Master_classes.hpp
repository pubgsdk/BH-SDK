...
#include "TBP_EyebrowColorCustomization_Master_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass TBP_EyebrowColorCustomization_Master.TBP_EyebrowColorCustomization_Master_C"));
		return ptr;
	}
