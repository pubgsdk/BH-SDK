...
#include "BP_ElectricityBox_01_structs.hpp"
...
class ABP_ElectricityBox_01_C : public ABP_GraffitiParent_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ElectricityBox_01.BP_ElectricityBox_01_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_ElectricityBox_01(int EntryPoint);
};
