...
#include "TBP_AI_CAP_Smoking_structs.hpp"
...
// BlueprintGeneratedClass TBP_AI_CAP_Smoking.TBP_AI_CAP_Smoking_C
// 0x0010 (0x0278 - 0x0268)
class ATBP_AI_CAP_Smoking_C : public ATigerAICAP
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass TBP_AI_CAP_Smoking.TBP_AI_CAP_Smoking_C"));
		return ptr;
	}
