...
{
public:
	TSet<class AChaosSolverActor*>                     ChaosSolverActorSet;                                      // 0x0038(0x0050) (CPF_Edit, CPF_NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData05[0x1];                                       // 0x0107(0x0001) MISSED OFFSET
	...
	TSet<class UPhysicalMaterial*>                     ChaosBreakingMaterialSet;                                 // 0x0138(0x0050) (CPF_Edit, CPF_NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData07[0x2];                                       // 0x018A(0x0002) MISSED OFFSET
	...
	unsigned char                                      UnknownData08[0x3];                                       // 0x0199(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData09[0x3];                                       // 0x01CD(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData10[0x10];                                      // 0x01D8(0x0010) MISSED OFFSET
	...
	unsigned char                                      UnknownData11[0x48];                                      // 0x01F0(0x0048) MISSED OFFSET
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("Class ChaosNiagara.NiagaraDataInterfaceFieldSystem"));
		return ptr;
	}
