...
#include "TBP_Ping_Bark_Looting_classes.hpp"
...
// Function TBP_Ping_Bark_Looting.TBP_Ping_Bark_Looting_C.EvaluateWorldActor
...
bool UTBP_Ping_Bark_Looting_C::EvaluateWorldActor(class ATigerPlayerState* InPlayerState, const struct FHitResult& InHitResult, struct FTigerPingWorldNetData* OutPingData, class AActor** OutOverrideActor)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_Ping_Bark_Looting.TBP_Ping_Bark_Looting_C.EvaluateWorldActor"));
...
// Function TBP_Ping_Bark_Looting.TBP_Ping_Bark_Looting_C.GetNotificationUIData
// (FUNC_Event, FUNC_Public, FUNC_HasOutParms, FUNC_HasDefaults, FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
...
struct FTigerPingNotificationUIData UTBP_Ping_Bark_Looting_C::GetNotificationUIData(const struct FTigerPingContext& InContext)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_Ping_Bark_Looting.TBP_Ping_Bark_Looting_C.GetNotificationUIData"));
