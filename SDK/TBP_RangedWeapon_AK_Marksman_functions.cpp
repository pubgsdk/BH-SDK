...
#include "TBP_RangedWeapon_AK_Marksman_classes.hpp"
...
// Function TBP_RangedWeapon_AK_Marksman.TBP_RangedWeapon_AK_Marksman_C.OnHitAuthority
...
void UTBP_RangedWeapon_AK_Marksman_C::OnHitAuthority(class ATigerCharacter* Instigator, class ATigerCharacter* Target)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_RangedWeapon_AK_Marksman.TBP_RangedWeapon_AK_Marksman_C.OnHitAuthority"));
