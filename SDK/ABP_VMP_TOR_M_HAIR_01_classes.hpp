...
#include "ABP_VMP_TOR_M_HAIR_01_structs.hpp"
...
// AnimBlueprintGeneratedClass ABP_VMP_TOR_M_HAIR_01.ABP_VMP_TOR_M_HAIR_01_C
// 0x26C0 (0x2980 - 0x02C0)
class UABP_VMP_TOR_M_HAIR_01_C : public UAnimInstance
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass ABP_VMP_TOR_M_HAIR_01.ABP_VMP_TOR_M_HAIR_01_C"));
		return ptr;
	}


	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_ABP_VMP_TOR_M_HAIR_01(int EntryPoint);
};
