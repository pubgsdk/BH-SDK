...
#include "ABP_PoseableMesh_E_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass ABP_PoseableMesh_E.ABP_PoseableMesh_E_C"));
		return ptr;
	}
