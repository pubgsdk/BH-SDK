...
#include "ABP_VMP_TOR_M_HAIR_06_structs.hpp"
...
class UABP_VMP_TOR_M_HAIR_06_C : public UAnimInstance
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass ABP_VMP_TOR_M_HAIR_06.ABP_VMP_TOR_M_HAIR_06_C"));
		return ptr;
	}


	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_ABP_VMP_TOR_M_HAIR_06(int EntryPoint);
};
