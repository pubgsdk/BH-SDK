...
{
	ENiagaraParticleResolutionMode__Full = 0,
	ENiagaraParticleResolutionMode__Quarter = 1,
	ENiagaraParticleResolutionMode__Sixteenth = 2,
	ENiagaraParticleResolutionMode__ENiagaraParticleResolutionMode_MAX = 3
};
