...
#include "TBP_Ping_Bark_Civilian_classes.hpp"
...
// Function TBP_Ping_Bark_Civilian.TBP_Ping_Bark_Civilian_C.EvaluateWorldActor
...
bool UTBP_Ping_Bark_Civilian_C::EvaluateWorldActor(class ATigerPlayerState* InPlayerState, const struct FHitResult& InHitResult, struct FTigerPingWorldNetData* OutPingData, class AActor** OutOverrideActor)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_Ping_Bark_Civilian.TBP_Ping_Bark_Civilian_C.EvaluateWorldActor"));
...
// Function TBP_Ping_Bark_Civilian.TBP_Ping_Bark_Civilian_C.GetNotificationUIData
// (FUNC_Event, FUNC_Public, FUNC_HasOutParms, FUNC_HasDefaults, FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
...
struct FTigerPingNotificationUIData UTBP_Ping_Bark_Civilian_C::GetNotificationUIData(const struct FTigerPingContext& InContext)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_Ping_Bark_Civilian.TBP_Ping_Bark_Civilian_C.GetNotificationUIData"));
