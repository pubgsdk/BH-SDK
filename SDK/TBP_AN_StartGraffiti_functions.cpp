...
#include "TBP_AN_StartGraffiti_classes.hpp"
...
// Function TBP_AN_StartGraffiti.TBP_AN_StartGraffiti_C.Received_Notify
...
bool UTBP_AN_StartGraffiti_C::Received_Notify(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function TBP_AN_StartGraffiti.TBP_AN_StartGraffiti_C.Received_Notify"));
