...
public:
	...
	struct FScriptDelegate                             OnQueueSubtitles;                                         // 0x0308(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_NoDestructor, CPF_NativeAccessSpecifierPrivate)
	struct FMulticastScriptDelegate                    OnAudioFinished;                                          // 0x0318(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_NativeAccessSpecifierPrivate)
	struct FMulticastScriptDelegate                    OnAudioPlaybackPercent;                                   // 0x0328(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_NativeAccessSpecifierPrivate)
...
public:
	...
	class UClass* /*UMatineeCameraShake*/              ShakeClass;                                               // 0x0108(0x0008) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("Class MovieSceneTracks.MovieScenePreAnimatedComponentTransformSystem"));
		return ptr;
	}
...
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x00A8(0x0008) MISSED OFFSET
	class UClass* /*UObject*/                          PropertyClass;                                            // 0x00B0(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
