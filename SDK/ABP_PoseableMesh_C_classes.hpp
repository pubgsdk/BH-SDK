...
#include "ABP_PoseableMesh_C_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass ABP_PoseableMesh_C.ABP_PoseableMesh_C_C"));
		return ptr;
	}
